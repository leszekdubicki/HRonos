class VacationRequestsController < ApplicationController
  ...
  def create
    ...
    @vacation_reques = @employee.vacation_requests.create(params[:vacation_request])
  ...
  private
    ...
    def vacation_request_params
      params.require(:vacation_request).permit(:employee_id, :start_date, :end_date, :comments, :manager_comments, :approved)
    end
end
